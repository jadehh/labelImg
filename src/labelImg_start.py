...
from src.labelImg_resources import *
from src.constants import *
from src.utils import *
from src.settings import Settings
from src.shape import Shape, DEFAULT_LINE_COLOR, DEFAULT_FILL_COLOR
from src.stringBundle import StringBundle
from src.canvas import Canvas
from src.zoomWidget import ZoomWidget
from src.labelDialog import LabelDialog
from src.colorDialog import ColorDialog
from src.labelFile import LabelFile, LabelFileError, LabelFileFormat
from src.toolBar import ToolBar
from src.pascal_voc_io import PascalVocReader
from src.pascal_voc_io import XML_EXT
from src.yolo_io import YoloReader
from src.yolo_io import TXT_EXT
from src.create_ml_io import CreateMLReader
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        file_list_layout.addWidget(self.filelabel)
        ...
        self.zoom_widget.setWhatsThis(
            u"Zoom in or out of the image. Also accessible with \n {} and {} from the canvas." .format(format_shortcut("Ctrl+[-+]"),
    ...
    def change_save_dir_dialog(self, _value=False):
        if self.default_save_dir is not None:
            ...
            if self.last_open_dir:
                try:
                    path = self.last_open_dir.split("JPEGImages")[0] + "Annotations"
                except Exception as e:
                    print("打开失败,失败原因为:{}".format(e))
                    path = ".."
            else:
                path = '..'
    ...
    def open_next_image(self, _value=False):
        ...
        if self.file_path is None:
            ...
            if current_index + 1 < len(self.m_img_list):
                filename = self.m_img_list[current_index + 1]
                self.filelabel.setText(
                    " 当前所在位置%d,总数%d" % (current_index + 2, len(self.m_img_list)))
...
def get_main_app(argv=[]):
    ...
    # Usage : labelImg_start.py image predefClassFile saveDir
